// ============================================================================
//  cpu_omp/main.cpp  —  renderer OpenMP (modo base: foto, con fondo)
//
...
//
//  Compilar:  g++ -O3 -fopenmp -I../common main.cpp -o omp
//  Correr:    ./omp 1024 ../results/omp.ppm
// ============================================================================
