// ============================================================================
//  cpu_serial/render_video.cpp  —  modo VIDEO serial (esferas orbitando)
//
...
//
//  Compilar:  g++ -O3 -I../common render_video.cpp -o render_video
// ============================================================================
...
int main(int argc,char**argv){
    ...
    std::printf("video-serial N=%d t=%.2f spheres=%zu  %.1f ms\n",
